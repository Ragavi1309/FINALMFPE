...
export class ConfigService {
  ...
  //loginserviceUrl = "http://pod4-cc-lb-722089690.us-east-2.elb.amazonaws.com/authapp"

  //offer microservice
  offerserviceUrl = "http://localhost:8000/offer"
  //offerserviceUrl = "http://pod4-cc-lb-722089690.us-east-2.elb.amazonaws.com/offer"

  //employee microservice
  employeeserviceUrl = "http://localhost:8070/employee"
  //employeeserviceUrl = "http://pod4-cc-lb-722089690.us-east-2.elb.amazonaws.com/employee"

  //points microservice
  pointsserviceUrl = "http://localhost:8090/points"
  //pointsserviceUrl = "http://pod4-cc-lb-722089690.us-east-2.elb.amazonaws.com/points"
  ...
  //get all offers 
  getAllOffers(token: string) {
    let options = {
    headers: { "Authorization": "Bearer " + token}
  }
  return this.http.get<Offer[]>(this.offerserviceUrl+"/getAllOffers/",options)
